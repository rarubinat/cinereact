// promotionsData.js
// This file defines all cinema promotions, including general offers, movie-specific deals, and contests.

// General promotions available for all customers
const generalPromotions = [
  {
    title: "2x1 Tuesdays",
    description: "Buy one ticket and get the second free every Tuesday.",
    badge: "Weekly", // Label for frequency or type
  },
  {
...
// Promotions tied to specific movies
...
// Contests that customers can participate in when buying tickets
const contests = [
  {
